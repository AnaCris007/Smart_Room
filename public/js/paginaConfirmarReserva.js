...
<body>
    <div class="confirmar-bg">
        ...
        <div class="confirmar-box">
            ...
            <div class="linha-info">
                ...
                <span class="info-valor" id="dataSelecionada"><%= data ? (new Date(data).toLocaleDateString('pt-BR')) : '19/05' %></span>
            </div>
            <div class="linha-info">
    ...
    <script>
// Este arquivo deve conter apenas JavaScript, não HTML/EJS!
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('btnConfirmar').onclick = async function(e) {
        ...
        const data = document.getElementById('dataSelecionada').textContent.trim();
        const inicio = hora;
